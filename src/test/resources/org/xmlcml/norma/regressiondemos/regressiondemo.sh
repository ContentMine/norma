...
../../../../../../../target/appassembler/bin/norma -q temp-acp -i fulltext.xml -o scholarly.html --xsl bmc2html
...
../../../../../../../target/appassembler/bin/norma -q temp-elife -i fulltext.xml -o scholarly.html --xsl bmc2html
...
../../../../../../../target/appassembler/bin/norma -q temp-f1000research -i fulltext.xml -o scholarly.html --xsl bmc2html
...
../../../../../../../target/appassembler/bin/norma -q temp-frontiers -i fulltext.xml -o scholarly.html --xsl bmc2html
ls -lt temp-frontiers/scholarly.html

echo norma hindawi
cp -R quickscrapeDirs/hindawi/247835 temp-hindawi
rm temp-hindawi/scholarly.html
../../../../../../../target/appassembler/bin/norma -q temp-hindawi -i fulltext.xml -o scholarly.html --xsl bmc2html
ls -lt temp-hindawi/scholarly.html

echo norma mdpi
cp -R quickscrapeDirs/mdpi/04-00932 temp-mdpi
rm temp-mdpi/scholarly.html
../../../../../../../target/appassembler/bin/norma -q temp-mdpi -i fulltext.xml -o scholarly.html --xsl bmc2html
ls -lt temp-mdpi/scholarly.html

echo norma peerj
cp -R quickscrapeDirs/peerj/727 temp-peerj
rm temp-peerj/scholarly.html
../../../../../../../target/appassembler/bin/norma -q temp-peerj -i fulltext.xml -o scholarly.html --xsl bmc2html
ls -lt temp-peerj/scholarly.html

echo norma pensoft
cp -R quickscrapeDirs/pensoft/4478 temp-pensoft
rm temp-pensoft/scholarly.html
../../../../../../../target/appassembler/bin/norma -q temp-pensoft -i fulltext.xml -o scholarly.html --xsl bmc2html
...
../../../../../../../target/appassembler/bin/norma -q temp-plosone -i fulltext.xml -o scholarly.html --xsl bmc2html
