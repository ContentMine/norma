...
<!--  COPY (must relearn <xs:copy> ) -->
	<xsl:template match="*[local-name()='p' or
	 local-name()='sup' or
	 local-name()='tr' or
	 local-name()='td' or
	 local-name()='table' or
...
<!--  SPANS, mainly in references -->
	<xsl:template match="*[local-name()='name' or
	 local-name()='given-names' or
	 local-name()='surname' or
	 local-name()='year' or
	 local-name()='article-title' or
	 local-name()='source' or
	 local-name()='volume' or
	 local-name()='fpage' or
	 local-name()='lpage']" >
...
<!--  IGNORES -->
	<xsl:template match="*[local-name()='contrib-group']/*[local-name()='contrib' and [@contrib-type='editor']" />
	...
	<xsl:template match="*[local-name()='front']/*[local-name()='article-meta']">
	  ...
	  <meta name="citation_pubdate" content="{concat(*[local-name()='pub-date' and @pub-type='epub']/*[local-name()='year'],'-',*[local-name()='pub-date' and @pub-type='epub']/*[local-name()='month'],'-',*[local-name()='pub-date' and @pub-type='epub']/*[local-name()='day'])}"/>
	  ...
	  <meta name="citation_pagecount" content="{*[local-name()='counts']/*[local-name()='page-count']/@count}"/>
	...
	<xsl:template match="*[local-name()='contrib' and @contrib-type='author']">
	  <meta name="citation_author" content="{concat(*[local-name()='name']/*[local-name()='given-names'],' ', *[local-name()='name']/*[local-name()='surname'])}"/>
	  <meta name="citation_author_institution_ref" content="{*[local-name()='xref']/*[local-name()='sup']}"/>
	</xsl:template>
	
	<xsl:template match="*[local-name()='aff']">
	  <meta name="citation_author_institution" content="{concat(*[local-name()='label'],' ',*[local-name()='addr-line'])}"/>
	</xsl:template>
	
	<xsl:template match="*[local-name()='body']">
	  <xsl:apply-templates select="/*[local-name()='article']/*[local-name()='front']/*[local-name()='article-meta']/*[local-name()='abstract']"/>
	  <xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="*[local-name()='sec']/*[local-name()='title']/*[local-name()='sec']/*[local-name()='title']/*[local-name()='sec']/*[local-name()='title']">
