...
/**
 * error detctors and corrector for potentially garbled strings
 * 
 ...
 *
 */
public class DetectorCorrector {
	...
	public DetectorCorrector() {
	}
		
	public AbstractEditorElement createEditorElement(InputStream is) {
