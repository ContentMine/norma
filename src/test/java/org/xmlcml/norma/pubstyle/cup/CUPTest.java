package org.xmlcml.norma.pubstyle.cup;
...
public class CUPTest {
	...
	private static final Logger LOG = Logger.getLogger(CUPTest.class);
	static {
		LOG.setLevel(Level.DEBUG);
	}
	static String PUB0 = "cup";
	static String PUB = "cup";
	static String PUB1 = "cup/clean";
